        ...
        <div class="row">
                <div class="col-xs-2 col-md-2">
                    ...
                    <div class="list-group">
                      ...
                      <a href="1_day_tour.php" class="list-group-item active">01 Day Tour</a>
                ...
                <div class="ccol-xs-10 col-md-6">
                    <h2>01 Day Tour Packages</h2>



                    <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#home">Tour Galle</a></li>
                    <li><a data-toggle="tab" href="#menu1">Tour Kandy</a></li>
                    <li><a data-toggle="tab" href="#menu2">Tour Pinnawala</a></li>
                    <li><a data-toggle="tab" href="#menu3">Tour Udawalawa</a></li>
                  </ul>
